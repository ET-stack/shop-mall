...
<head>
    ...
    <link rel="stylesheet" href="css/bootstrap/3.3.6/bootstrap.css" type="text/css" />
    <link rel="stylesheet" href="css/admin/simple-line-icons.css" type="text/css" />
    <link rel="stylesheet" href="css/admin/app.css" type="text/css" />
</head>
<body background="img/admin/bodybg.jpg">
<section id="content" class="m-t-lg wrapper-md animated fadeInUp ">
    <div class="container aside-xl" style="margin-top: 48px;">
        ...
        <section class="m-b-lg">
            ...
            <form action="/admin_category_list" method="post" >
